        ...
        if (a > 0 && materials.size() > 0) {
            ...
            if (materialId != -1) {
                ...
                if (!ambientTexturePath.empty()) {
                    ...
                    currentTexture = LoadTexture(basePath + ambientTexturePath,
                                                 "ambientTexture");
                ...
                if (!diffuseTexturePath.empty()) {
                    gps::Texture currentTexture;
                    currentTexture = LoadTexture(basePath + diffuseTexturePath,
                                                 "diffuseTexture");
                    textures.push_back(currentTexture);
                }
                ...
                if (!specularTexturePath.empty()) {
                    gps::Texture currentTexture;
                    currentTexture = LoadTexture(basePath + specularTexturePath,
                                                 "specularTexture");
                    textures.push_back(currentTexture);
                }
            }
